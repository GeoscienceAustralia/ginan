SUBROUTINE time_GPSweek3 (mjd, sec00, GPS_week, GPS_wsec, GPSweek_mod1024, GPS_day)


! ----------------------------------------------------------------------
! Subroutine:	time_GPSweek3.f90
! ----------------------------------------------------------------------
! Purpose:
...
! ----------------------------------------------------------------------
! IN
      REAL (KIND = prec_d), INTENT(IN) :: mjd, sec00
! OUT
...
! Seconds since start of GPS week 	  
      ...
      GPS_wsec = INT(GPS_day) * 86400.0D0 + sec00
! ----------------------------------------------------------------------
	  !print *,"mjd       ", mjd	  
