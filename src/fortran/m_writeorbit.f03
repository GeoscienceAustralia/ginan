...
SUBROUTINE writeorbit (wrtArray, filename)

! ----------------------------------------------------------------------
! SUBROUTINE: writeorbit 
! ----------------------------------------------------------------------
! Purpose:
!  Write orbit array to an output ascii file
! ----------------------------------------------------------------------
! Input arguments:
...
! ----------------------------------------------------------------------
! Last modified:
! - Thomas Papanikolaou, 13 February 2019:
!   writearray.f03 subroutine has been modified in order to write the 
!	estimated orbit to output file (ascii) based on an internal adopted 
