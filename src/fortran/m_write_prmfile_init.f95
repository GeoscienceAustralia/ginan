MODULE m_write_prmfile_init


! ----------------------------------------------------------------------
! MODULE: m_write_prmfile_init.f03
! ----------------------------------------------------------------------
! Purpose:
!  Module for create/write parameters initialization file 
! ----------------------------------------------------------------------
...
SUBROUTINE write_prmfile_init (fname, param_id_array, param_value_array)
...
! ----------------------------------------------------------------------
! Write initial values of parameters to file
DO i = 1 , Nparam

! Parameters Keyword read 
param_id = param_id_array(i)
param_value = param_value_array(i)
...
END DO
! ----------------------------------------------------------------------
!PRINT *, "WRITE param_id, param_value: ", Nparam, param_id, param_value
