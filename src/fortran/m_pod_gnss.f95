...
if (yaml_found .and. yml_pod_mode /= MODE_DATA_INT) then
    found = .false.
...
! TIME_SCALE: global variable in module mdl_param.f95
! ----------------------------------------------------------------------
If (yml_time_scale == TT_time) Then
! MJD_to and SEC_to :: global variables in mdl_param.f95
