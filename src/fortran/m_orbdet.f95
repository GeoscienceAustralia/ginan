...
prn_out = 'G33' ! not a real PRN. but dummy to be changed for debugging purposes
...
!   ALLOCATE (ECOM_coef(NPARAM_glb), STAT = AllocateStatus)
   ...
   if (AllocateStatus .ne. 0) then
        ...
        call report('FATAL', pgrm_name, 'orbdet', mesg, 'src/fortran/m_orbdet.f95', 1)
   end if
...
! Orbit arc length (estimated part) :: "orbarc" via module mdl_param.f95
