...
)
{
    ...
    double r_p[6];
    {
        ...
        result = jpl_pleph(
            jplEph_ptr,
            mjdTT.to_double() + JD2MJD,
            static_cast<int>(thirdBody),
            eEarth,
            r_p,
            !!vel_ptr
        );
    ...
    switch (result)
    {
        case 0:
            ...
            return true;
        case -1:
            std::cout << "JPL_EPH_OUTSIDE_RANGE" << "\n";
            break;
        case -2:
            std::cout << "JPL_EPH_READ_ERROR" << "\n";
            break;
        case -3:
            std::cout << "JPL_EPH_QUANTITY_NOT_IN_EPHEMERIS" << "\n";
            break;
        case -5:
            std::cout << "JPL_EPH_INVALID_INDEX" << "\n";
            break;
        case -6:
            std::cout << "JPL_EPH_FSEEK_ERROR" << "\n";
            break;
        default:
            std::cout << "Result is out of Known Situation" << "\n";
            break;
    }
...
bool planetPosEcef(GTime time, E_ThirdBody thirdBody, VectorEcef& rBody, ERPValues erpv)
{
    VectorEci rBodyEci;
