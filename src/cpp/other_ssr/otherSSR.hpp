...
const int ssrUdi[16] = {1, 2, 5, 10, 15, 30, 60, 120, 240, 300, 600, 900, 1800, 3600, 7200, 10800};
...
vector<uint8_t>
encodecompactCOD(map<SatSys, SSRCodeBias>& codBiaMap, int updateIntIndex, bool last);

vector<uint8_t>
encodecompactPHS(map<SatSys, SSRPhasBias>& phsBiaMap, int updateIntIndex, bool last);
