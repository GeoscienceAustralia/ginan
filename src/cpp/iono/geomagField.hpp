 ...
 * 13th Generation International Geomagnetic Reference Field Schmidt semi-normalised spherical
 * harmonic coefficients, degree n=1,13 in units nanoTesla for IGRF and definitive DGRF main-field
 * models (degree n=1,8 nanoTesla/year for secular variation (SV))
 */
