	...
	KFState&	kfState)
{
	...
	kfState.getKFValue({.type = KF::EOP,		.str= "_XP"},	erpd.xp);				erpd.xp			*= MAS2R;
	kfState.getKFValue({.type = KF::EOP,		.str= "_YP"},	erpd.yp);				erpd.yp			*= MAS2R;
	kfState.getKFValue({.type = KF::EOP,		.str= "_UT1"},	erpd.ut1_utc);			erpd.ut1_utc	*= MTS2S;
	kfState.getKFValue({.type = KF::EOP_RATE,	.str= "_XP"},	erpd.xpr);				erpd.xpr		*= MAS2R;
	kfState.getKFValue({.type = KF::EOP_RATE,	.str= "_YP"},	erpd.ypr);				erpd.ypr		*= MAS2R;
	kfState.getKFValue({.type = KF::EOP_RATE,	.str= "_UT1"},	erpd.lod);				erpd.lod		*= MTS2S * -1;
