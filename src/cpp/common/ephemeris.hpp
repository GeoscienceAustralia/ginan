...
struct Eph : BrdcEph, KeplerEph
{
    ...
    double isc[6] = {};  ///< inter-signal corrections
                         ...
                         ///< isc[2]=ISC_L5I5, isc[3]=ISC_L5Q5, isc[4]=ISC_L1Cd, isc[5]=ISC_L1Cp BDS
                         ///< CNV1: isc[0]=ISC_B1Cd BDS	 CNV2: isc[1]=ISC_B2ad
    double sis[5] = {};  ///< signal in space accuracy index
                         ///< BDS CNVX sis[0]=SISAI_oe, sis[1]=SISAI_ocb, sis[2]=SISAI_oc1,
                         ///< sis[3]=SISAI_oc2, sis[4]=SISMAI
...
struct Att
{
    ...
    E_ObxFrame  frame;
    Quaterniond q =
        Eigen::Quaterniond::Identity();  ///< satellite attitude represented w/ a quaternion
};
...
struct Ceph : KeplerEph
{
    ...
    double isc[6] = {};  ///< inter-signal corrections
                         ...
                         ///< CNV1: isc[0]=ISC_B1Cd BDS	 CNV2: isc[1]=ISC_B2ad
    double sis[5] = {};  ///< signal in space accuracy index
                         ///< BDS sis[0]=SISAI_oe, sis[1]=SISAI_ocb, sis[2]=SISAI_oc1,
                         ///< sis[3]=SISAI_oc2, sis[4]=SISMAI
    double tops   = 0;   ///< t_op (s) in week
