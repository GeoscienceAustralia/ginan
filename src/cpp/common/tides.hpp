...
bool readBlq(string file, E_LoadingType type);
...
VectorEnu
tideOceanLoadAdjusted(Trace& trace, GTime time, MjDateUt1 mjdUt1, TideMap& otlDisplacement);
...
VectorEnu tideSolidPole(Trace& trace, MjDateTT mjdTT, const VectorPos& pos, ERPValues& erpv);

VectorEnu tideOceanPole(Trace& trace, MjDateTT mjdTT, const VectorPos& pos, ERPValues& erpv);
