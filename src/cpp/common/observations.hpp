...
/** Raw observation data from a receiver for a single frequency. Not to be modified by processing
 * functions
 */
struct RawSig
{
...
{
    map<E_FType, Sig>
        sigs;       ///> Map of signals available in this observation (one per frequency only)
    map<E_FType, list<Sig>>
        sigsLists;  ///> Map of all signals available in this observation (may include multiple per
                    /// frequency, eg L1X, L1C)
...
//========================================================================================================
/*
#Mission Name            SP3c Code  ILRS ID    NORAD     Altitude [km] Inclination [deg]   Tracking
Status #                        (PRN)                           From       To GPS-MET L02 9501703
23547      740      740            69.900               Off
*/
//========================================================================================================
struct SatIdentity
{
