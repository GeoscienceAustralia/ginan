...
const double uraSsr[] = {0,    0.25,    0.5,    0.75,    1,    1.25,    1.5,    1.75,
                         2,    2.75,    3.5,    4.25,    5,    5.75,    6.5,    7.25,
                         8,    10.25,   12.5,   14.75,   17,   19.25,   21.5,   23.75,
                         26,   32.75,   39.5,   46.25,   53,   59.75,   66.5,   73.25,
                         80,   100.25,  120.5,  140.75,  161,  181.25,  201.5,  221.75,
                         242,  302.75,  363.5,  424.25,  485,  545.75,  606.5,  667.25,
                         728,  910.25,  1092.5, 1274.75, 1457, 1639.25, 1821.5, 2003.75,
                         2186, 2732.75, 3279.5, 3826.25, 4373, 4919.75, 5466.5, 6013.25};
...
struct SSRPhasBias : SSRBias
{
    ...
    map<E_ObsCode, SSRPhaseCh>
        ssrPhaseChs;    ///< Additional data for SSR phase messages, for each channel
};
