...
double svaToSisa(int sva)
{
    if (sva < 0)
        ...
        return (0.0 + (sva - 0) * 0.01);
    else if (sva <= 74)
        return (0.5 + (sva - 50) * 0.02);
    else if (sva <= 99)
        return (1.0 + (sva - 75) * 0.04);
    else if (sva <= 125)
        return (2.0 + (sva - 100) * 0.16);
    else
        return -1;
}
...
int sisaToSva(double sisa)
{
    if (sisa < 0)
        ...
        return (int)((((sisa - 0.0) / 0.01) + 0) + 0.5);
    else if (sisa <= 0.98)
        return (int)((((sisa - 0.5) / 0.02) + 50) + 0.5);
    else if (sisa <= 1.96)
        return (int)((((sisa - 1.0) / 0.04) + 75) + 0.5);
    else if (sisa <= 6.00)
        return (int)((((sisa - 2.0) / 0.16) + 100) + 0.5);
    else
        return 255;
}
 ...
 */
void wrapPlusMinusPi(double& angle)  ///< Angle to wrap
{
    while (angle <= -PI)
        angle += 2 * PI;
    while (angle > PI)
 ...
 */
void wrap2Pi(double& angle)  ///< Angle to wrap
{
    while (angle < 0)
        angle += 2 * PI;
    while (angle >= 2 * PI)
