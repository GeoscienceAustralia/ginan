...
struct IcdDecoder
{
    ...
    bool decodeGpsTlmWord(vector<int>& words, Eph& eph) { return true; }
    ...
    )
    {
        ...
        {
            case 1:
                return decodeGPSSubframe1(words, eph);
            case 2:
                return decodeGPSSubframe2(words, eph);
            case 3:
                return decodeGPSSubframe3(words, eph);
        }
        return false;
    }
};
