    ...
    const vector<string>& descriptorVec)	///< List of strings of keys of yaml hierarchy
{
...

    {
        ...
        auto& thing = orbOpts.drag_cd;	setInited(orbOpts, thing, tryGetFromYaml(thing, orbitsNode, { "0@ drag_cd" }, "Coefficient of drag of the satellite"));
        ...
        auto& thing = orbOpts.drag;	setInited(orbOpts, thing, tryGetFromYaml(thing, orbitsNode, { "@ drag" }, "Model accelerations due to drag"));
    } {
    ...
    char** argv)	///< Passthrough calling argument list
{
    ...
    valid &= checkValidFiles(acsConfig.atmos_ocean_dealiasing_files, "Atmosphere and Ocean De-aliasing (AOD1B file)");
    ...
    boost::program_options::variables_map& newCommandOpts)	///< Variable map object of command line options
{
    ...
    for (int i = 0; i < yamlList.size(); i++)
    {
        ...
        // 		inputs
        {
            ...
            getAppendFiles(space_weather_files, inputs, { "4@ space_weather_files" }, "List of space weather files to use");
            ...
            getAppendFiles(atmos_ocean_dealiasing_files, tides, { "@ atmos_ocean_dealiasing_files" }, "List of tide files to use");
        ...
        // 		processing_options
        {
            ...
            // 			gnss_general
            {
				...
				tryGetFromYaml	(pppOpts.merge_correlated_states,			general, {"@ merge_correlated_states"			}, "Combine correlated states to eliminate unestimable states");
...
// 			orbit_propagation
    ...
    // 	Try to change all filenames to replace <YYYY> etc with other values.
    {
        ...
        replaceTags(space_weather_files);						globber(space_weather_files);
        ...
        replaceTags(atmos_ocean_dealiasing_files);				globber(atmos_ocean_dealiasing_files);
