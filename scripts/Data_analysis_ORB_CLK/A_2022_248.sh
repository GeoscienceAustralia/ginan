...
export ORB_FILE=/mnt/e/2022_248_IGS/pod_ic
#export ORB_FILE_PRD=/mnt/e/2022_223/pod_prd
export CLK_FILE=/mnt/e/2022_248_IGS
...
export PYTHON_FILES=/data/ginan/scripts
 ...
 python3 $PYTHON_FILES/sp3_compare.py $STD_FILE/igr22261.sp3 $ORB_FILE/*.sp3 --ylims -50 50 -hlm ECF 
#  python3 $PYTHON_FILES/sp3_compare.py $STD_FILE/igr22260.sp3 $STD_FILE/GBM0MGXRAP_20222470000_01D_05M_ORB.SP3 --ylims -50 50 -hlm ECF 
