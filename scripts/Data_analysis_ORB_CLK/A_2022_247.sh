...
export ORB_FILE=/mnt/e/2022_247_IGS/pod_ic
#export ORB_FILE_PRD=/mnt/e/2022_223/pod_prd
export CLK_FILE=/mnt/e/2022_247_IGS
...
export PYTHON_FILES=/data/ginan/scripts
 ...
 python3 $PYTHON_FILES/sp3_compare.py $STD_FILE/igr22260.sp3 $ORB_FILE/*.sp3 --ylims -50 50 -hlm ECF 
#  python3 $PYTHON_FILES/sp3_compare.py $STD_FILE/igr22261.sp3 $STD_FILE/GAG0EXPRAP_20222480000_01D_15M_ORB.sp3 --ylims -50 50 -hlm ECF 
...
#  python3 $PYTHON_FILES/sp3_compare.py $STD_FILE/igs22172.sp3 $ORB_FILE_PRD/*.sp3 --ylims -50 50 -hlm ECF 
 ...
 python3 $PYTHON_FILES/rms_bar_plot.py -i $ORB_FILE/*orbdiff_rtn.out -c G 
