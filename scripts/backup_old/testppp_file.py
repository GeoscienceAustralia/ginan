...
datafile=station+'00'+country+'_S_20'+date+'0000_01D_30S_MO.rnx'
...
comm="timeout "+maxtim+" ./pea --config " + conf_file
os.system(comm + " --rnx " + data_directory + datafile + " > log/"+station+date+".log")
