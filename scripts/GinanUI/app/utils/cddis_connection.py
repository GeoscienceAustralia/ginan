"""
Utilities for managing the EMAIL used by the CDDIS flow and for quick connectivity / authentication checks.

Handles reading and writing the EMAIL credential (from env var or CDDIS.env), deriving
the username from .netrc / _netrc, and testing connectivity and Earthdata authentication
against cddis.nasa.gov
"""
...
#region .NETRC / _NETRC Account Information Handling
