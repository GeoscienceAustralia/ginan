...
[![Version](https://img.shields.io/badge/version-v4.1.4-blue.svg)](https://github.com/GeoscienceAustralia/ginan/releases)
...
Expected output:
```
PEA starting... (main ginan-v4.1.4 from ...)
Options:
  -h [ --help ]     Help
  -q [ --quiet ]    Less output
  ...
...
**Developed by [Geoscience Australia](https://www.ga.gov.au/)** | **Version 4.1.4** | **[GitHub Repository](https://github.com/GeoscienceAustralia/ginan)**
