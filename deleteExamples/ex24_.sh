...
vg=
yaml_file=
pod_opts="-m 4 -q 2 -k 2 -w 0 -r eopc04_IAU2000.62-now -o igs20624.sp3"
while [ "$1" != "" ]; do
    case $1 in
...
ln -s ~/pod/tables/eopc04_IAU2000.62-now . >& /dev/null
...
python3 ~/pod/scripts/rms_bar_plot.py -i gag20624_igs20624_orbdiff_rtn.out -d . -c G >& pod.rms
